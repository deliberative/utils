...
/**
 * @function
 * Returns the number of times an item is in an array.
 *
 ...
 */
const countOccurrencesInArray = async (
  array: Uint8Array[],
  item: Uint8Array,
  ...
  const wasmMemory = module
    ? module.wasmMemory
    : utilsMemory.countOccurencesInArray(arrayLen, itemLen);
  ...
  const result = dutilsModule._occurrences_in_array(
    arrayLen,
    itemLen,
    arr.byteOffset,
    itm.byteOffset,
...
export default countOccurrencesInArray;
