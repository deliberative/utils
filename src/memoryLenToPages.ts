 ...
 *
 * @param memoryLen: The number of bytes to load in WASM.
 * @param minPages: If we want to set specific lower memory limit.
 * @param maxPages: If we want to set specific maximum memory limit.
 *
 * @returns number
 */
